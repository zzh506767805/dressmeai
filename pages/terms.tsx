...
type TermsMessages = typeof enLegal.terms
type SectionKey = keyof TermsMessages['sections']

interface TermsProps {
  content: TermsMessages
}
...
export const getStaticProps: GetStaticProps<TermsProps> = async ({ locale }) => {
